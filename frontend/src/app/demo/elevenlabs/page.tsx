...
import { useElevenLabsVoices, useTextToSpeech } from "@/lib/demos/elevenlabs-client";
...
const ElevenLabsDemoPage = () => {
  ...
  const [text, setText] = useState("Welcome to EchoLag. Let's practice that matcha order!");
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 py-10 sm:px-6 lg:px-8">
      <SectionHeading
        ...
        subtitle="Convert practice scripts into narrated audio using server-side API routes."
      />
